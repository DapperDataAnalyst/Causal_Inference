...
(w_x0*(120-110) + w_x1*(90-90))/(w_x0+w_x1)
```
### Part e)
```{r}
# Same numbers as Part d?
```
...
ATT_bart  # I feel this is likely incorrect
...
for (cov in c('X1','X2')){
  ...
  plot(covplot[trimmed_dat$Z==1], ite_means, pch=16, cex=0.75, col="red", ylim = c(-1,2), 
